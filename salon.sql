...
INSERT INTO public.appointments VALUES (7, 6, 2, '2');
...
INSERT INTO public.customers VALUES (6, '2', '2');
...
--
-- Name: appointments appointments_costumer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointments_costumer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);
